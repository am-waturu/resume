                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="works__item">
                                <h2 class="work__title"> <span class="project__count">01</span> <a class="ajax-popup-link hbrable" href="/headphones">BɚZE</a> </h2>
                            </div>
                           <!-- work-item -->
                            <div class="works__item_0">
                                <h2 class="work__title_0"> <span class="project__count_0">02</span> <a class="ajax-popup-link hbrable" href="/table">Glæss</a> </h2>
                            </div>
                             <!-- work-item -->
                           <div class="works__item_1">
                                <h2 class="work__title_1"> <span class="project__count_1">03</span> <a class="ajax-popup-link hbrable" href="/blog">Not.ed</a></h2>
                            </div>
                             <!-- work-item 
                           <div class="works__item">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-12">
                    ...
                    <a class="button-default slide-vertical hbrable" href="/contact" data-splitting>Contact</a>
                </div>
            </div>
        </div>
    </div>
